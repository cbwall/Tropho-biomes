...
pacman::p_load('knitr', 'lme4', 'ggridges', 'lme4', 'lmerTest', 'tidyverse', 'magrittr', 'effects', 'plyr',
...
YSI$TB<-factor(YSI$TB, levels=c("L+", "L-", "H+", "H-", "Pl+", "Pl-"))

YSI$Nutrients<-factor(YSI$Nutrients, levels=c("Low", "High", "Plant"))
...
make.fac<-c("Time.point", "Tank.ID", "Nutrients", "Trophic.type", "Plankton.pres.abs", "TB")
YSI[make.fac]<-lapply(YSI[make.fac], factor) # make all these factors

# rearrange
YSI<-YSI %>% dplyr::select(Date, Time, Time.point, Dawn..Dusk, Tank.ID, Nutrients, Trophic.type, 
                    Plankton.pres.abs, TB, temp..C, DO..percent, DO..mg.L, spc, cond, pH)
...
# make new dataframe
T05.O2<- T05.Dawn1 %>% dplyr::select(-Time, -Dawn..Dusk, -temp..C, -DO..mg.L, -spc, -cond, -pH)
...
# make new dataframe
T1.O2<- T1.Dawn1 %>% dplyr::select(-Time, -Dawn..Dusk, -temp..C, -DO..mg.L, -spc, -cond, -pH)
...
# make new dataframe
T2.O2<- T2.Dawn1 %>% dplyr::select(-Time, -Dawn..Dusk, -temp..C, -DO..mg.L, -spc, -cond, -pH)
...
# make new dataframe
T3.O2<- T3.Dawn1 %>% dplyr::select(-Time, -Dawn..Dusk, -temp..C, -DO..mg.L, -spc, -cond, -pH)
...
T05.PM1<-ggplot(T05.O2, aes(x=TB, y=dusk1, color=Trophic.type, fill=Trophic.type)) +
...
T05.AM1<-ggplot(T05.O2, aes(x=TB, y=dawn1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T05.PM2<-ggplot(T05.O2, aes(x=TB, y=dusk2, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time 0.5 NEP
NEP.T05<-ggplot(T05.O2, aes(x=TB, y=NEP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time 0.5 Resp
Resp.T05<-ggplot(T05.O2, aes(x=TB, y=Resp, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.PM1<-ggplot(T1.O2, aes(x=TB, y=dusk1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.AM1<-ggplot(T1.O2, aes(x=TB, y=dawn1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.PM2<-ggplot(T1.O2, aes(x=TB, y=dusk2, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time1 NEP
NEP.T1<-ggplot(T1.O2, aes(x=TB, y=NEP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time1 Resp
Resp.T1<-ggplot(T1.O2, aes(x=TB, y=Resp, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.PM1<-ggplot(T2.O2, aes(x=TB, y=dusk1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.AM1<-ggplot(T2.O2, aes(x=TB, y=dawn1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.PM2<-ggplot(T2.O2, aes(x=TB, y=dusk2, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time1 NEP
NEP.T2<-ggplot(T2.O2, aes(x=TB, y=NEP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time1 Resp
Resp.T2<-ggplot(T2.O2, aes(x=TB, y=Resp, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.AM1<-ggplot(T3.O2, aes(x=TB, y=dawn1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.PM1<-ggplot(T3.O2, aes(x=TB, y=dusk1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.AM2<-ggplot(T3.O2, aes(x=TB, y=dawn1, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time1 NEP
NEP.T3<-ggplot(T3.O2, aes(x=TB, y=NEP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
#Time1 Resp
Resp.T3<-ggplot(T3.O2, aes(x=TB, y=Resp, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
ggsave("figures/O2.TB.pdf", height=10, width=14)
...
ggsave("figures/NEP.Resp.TB.pdf", height=10, width=14)
```

DO stats (dusk)
```{r DO stats}
#T0.5
DO.TO5.mod<-lm(dusk1~Nutrients+Plankton.pres.abs, data= T05.O2)
hist(resid(DO.TO5.mod), xlab="Residuals")
Anova(DO.TO5.mod, type=2) # **nutrient effect: Low (b), High (c), Plant (a)
posthoc.DO.T05<-emmeans(DO.TO5.mod, ~Nutrients); multcomp::cld(posthoc.DO.T05, Letters=letters)

#T1, square-root transform
DO.T1.mod<-lm(dusk1~Nutrients+Plankton.pres.abs, data= T1.O2)
hist(resid(DO.T1.mod), xlab="Residuals")
Anova(DO.T1.mod, type=2) # nutrient effect: Low (ab), High (b), Plant (a)
posthoc.DO.T1<-emmeans(DO.T1.mod, ~Nutrients); multcomp::cld(posthoc.DO.T1, Letters=letters)

#T2
DO.T2.mod<-lm(dusk1~Nutrients+Plankton.pres.abs, data= T2.O2)
Anova(DO.T2.mod, type=2) # **nutrient effect:  Low (b), High (c), Plant (a)
posthoc.DO.T2.nut<-emmeans(DO.T2.mod, ~Nutrients); multcomp::cld(posthoc.DO.T2.nut, Letters=letters)

#T3
DO.T3.mod<-lm(dusk1~Nutrients+Plankton.pres.abs, data= T3.O2)
Anova(DO.T3.mod, type=2) # **nutrient effect:  Low (b), High (b), Plant (a)
posthoc.DO.T3<-emmeans(DO.T3.mod, ~Nutrients); multcomp::cld(posthoc.DO.T3, Letters=letters)
```
...
## note that lme4 and phyloseq have compatibility issues, may need to run the below to resolve
# "remotes::install_github("joey711/phyloseq", force = TRUE)" then restart R

########### NEP
#T0.5
NEP.TO5.mod<-lm(NEP~Nutrients+Plankton.pres.abs, data= T05.O2, na.action=na.exclude)
hist(resid(NEP.TO5.mod))
Anova(NEP.TO5.mod, type=2) # **nutrient effect** Low (ab), High (b), Plant (a)
posthoc.NEP.T05.nut<-emmeans(NEP.TO5.mod, ~Nutrients); multcomp::cld(posthoc.NEP.T05.nut, Letters=letters)
...
Anova(Resp.T2.mod, type=2) # **nutrient effect** Low (b), High (a), Plant (ab)
...
Anova(Resp.T3.mod, type=2) # **nutrient effect** Low (b), High (b), Plant (a)
...
T05.chl<-ggplot(chl[(chl$Time.point=="T0.5"),], aes(x=TB, y=mean.chl, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.chl<-ggplot(chl[(chl$Time.point=="T1"),], aes(x=TB, y=mean.chl, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.chl<-ggplot(chl[(chl$Time.point=="T2"),], aes(x=TB, y=mean.chl, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.chl<-ggplot(chl[(chl$Time.point=="T3"),], aes(x=TB, y=mean.chl, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
Anova(chl.T2.mod, type=3) # **nutrient effect:  Low (a), High (a), Plant (b)
posthoc.chl.T2<-emmeans(chl.T2.mod, ~Plankton.pres.abs|Nutrients); multcomp::cld(posthoc.chl.T2, Letters=letters) #plankton effect (H-b, H+a)
posthoc.chl.T2.nut<-emmeans(chl.T2.mod, ~Nutrients); multcomp::cld(posthoc.chl.T2.nut, Letters=letters)
...
T05.TN<-ggplot(water.char[(water.char$Time.point=="T0.5"),], aes(x=TB, y=TDN, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.TN<-ggplot(water.char[(water.char$Time.point=="T1"),], aes(x=TB, y=TDN, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.TN<-ggplot(water.char[(water.char$Time.point=="T2"),], aes(x=TB, y=TDN, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.TN<-ggplot(water.char[(water.char$Time.point=="T3"),], aes(x=TB, y=TDN, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T05.TP<-ggplot(water.char[(water.char$Time.point=="T0.5"),], aes(x=TB, y=TDP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.TP<-ggplot(water.char[(water.char$Time.point=="T1"),], aes(x=TB, y=TDP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.TP<-ggplot(water.char[(water.char$Time.point=="T2"),], aes(x=TB, y=TDP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.TP<-ggplot(water.char[(water.char$Time.point=="T3"),], aes(x=TB, y=TDP, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
Anova(TDP.T3.mod, type=2) # **nutrient effect: Low (a), High (a), Plant (b)
...
T05.DOC<-ggplot(water.char[(water.char$Time.point=="T0.5"),], aes(x=TB, y=DOC, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T1.DOC<-ggplot(water.char[(water.char$Time.point=="T1"),], aes(x=TB, y=DOC, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T2.DOC<-ggplot(water.char[(water.char$Time.point=="T2"),], aes(x=TB, y=DOC, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
T3.DOC<-ggplot(water.char[(water.char$Time.point=="T3"),], aes(x=TB, y=DOC, color=Trophic.type, fill=Trophic.type)) +
  geom_boxplot(alpha=0.5) +
  geom_point(pch = 21, position = position_jitterdodge()) +
  scale_color_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
  scale_fill_manual(values = c("lightskyblue", "palegreen3", "lightsalmon3")) +
...
Anova(DOC.TO5.mod, type=2) # **nutrient effect:  Low (a), High (a), Plant (b)
...
Anova(DOC.T2.mod, type=2) # **nutrient effect (close):  Low (a), High (b), Plant (c)
...
ggsave("figures/survival.pdf", height=5, width=5)
...
ggsave("figures/size.histograms.pdf", height=12, width=10)
...
ggsave("figures/total.fecund.pdf", height=5, width=12)
...
ggsave("figures/eggs.mean.by.indiv.pdf", height=5, width=5)

# model test
egg.young.mod<-lm(egg.and.young~Inoc.treatment+Inoc.plank.nutr.source, data=eggY.mean.NA)
anova(egg.young.mod)
...
######
Young.indiv.mean.plot<-ggplot(df4, aes(x=Inoc.treatment, y=young.number, group=Inoc.plank.nutr.source, 
               color=Inoc.plank.nutr.source)) + 
  geom_errorbar(aes(ymin=young.number-se, ymax=young.number+se), 
                width=0.0, position=pd) +
