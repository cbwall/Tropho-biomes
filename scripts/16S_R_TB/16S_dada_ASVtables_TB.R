...
saveRDS(asv_fasta, "output/ASV_fasta.rds")
...
write.table(asv_tab, "output/ASV_counts.tsv", sep = "\t", quote = F, col.names = NA)
...
write.table(taxa, "output/ASV_taxonomy.tsv", sep = "\t", quote = F, col.names = NA)
